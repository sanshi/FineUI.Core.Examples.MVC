# FineUI.Core.Examples.MVC

FineUI.Core.Examples.MVC 是 FineUI 官方完整示例项目。本仓库是该项目的唯一真相源，欢迎通过 Issue 和 Pull Request 参与技术讨论与改进。
...
```powershell
dotnet restore FineUI.Core.Examples.MVC.sln
dotnet build FineUI.Core.Examples.MVC.sln -c Release --no-restore
```
