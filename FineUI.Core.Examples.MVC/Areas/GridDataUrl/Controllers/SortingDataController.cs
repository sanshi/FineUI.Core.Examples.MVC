...
{
    [Area("GridDataUrl")]
    public class SortingDataController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: GridDataUrl/SortingData
        public IActionResult Index(string sortField, string sortDirection, bool? data2)
        {
