...
{
    [Area("GridDataUrl")]
    public class RowButtonController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        ...
        public IActionResult Grid1_CustomEvent(string eventType, int rowIndex, string rowId, string rowText)
        {
