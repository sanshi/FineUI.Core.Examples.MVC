...
{
    [Area("GridCard")]
    public class CardMultiSelectShowCheckBoxAutoHideController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: GridCard/CardMultiSelectShowCheckBoxAutoHide
