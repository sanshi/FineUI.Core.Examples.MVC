...
{
    [Area("GridCard")]
    public class CardMultiSelectKeepCurrentSelectionController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: GridCard/CardMultiSelectKeepCurrentSelection
