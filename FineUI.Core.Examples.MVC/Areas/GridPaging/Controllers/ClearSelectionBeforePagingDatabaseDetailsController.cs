...
{
    [Area("GridPaging")]
    public class ClearSelectionBeforePagingDatabaseDetailsController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: GridPaging/ClearSelectionBeforePagingDatabaseDetails
