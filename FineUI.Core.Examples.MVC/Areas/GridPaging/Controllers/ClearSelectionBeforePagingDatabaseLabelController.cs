...
{
    [Area("GridPaging")]
    public class ClearSelectionBeforePagingDatabaseLabelController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: GridPaging/ClearSelectionBeforePagingDatabaseLabel
