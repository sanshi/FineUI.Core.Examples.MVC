...
{
    [Area("GridPaging")]
    public class PagerAutoSimpleModeController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: GridPaging/PagerAutoSimpleMode
        ...
        {
            // 1.设置总项数（数据库分页初始化时，一定要设置总记录数 RecordCount）
        ...
        /// <summary>
        /// 模拟数据库分页（实际项目中请直接使用 SQL 语句返回分页数据！）
        /// </summary>
