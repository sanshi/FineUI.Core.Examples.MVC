...
{
    [Area("MobileDataList")]
    public class DataListSelectedValueArrayController : FineUI.Core.Examples.MVC.Controllers.BaseMobileController
    {
        // GET: MobileDataList/DataListSelectedValueArray
