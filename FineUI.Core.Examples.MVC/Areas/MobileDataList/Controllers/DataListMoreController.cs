...
namespace FineUI.Core.Examples.MVC.Areas.MobileDataList.Controllers
{
    ...
    public class DataListMoreController : FineUI.Core.Examples.MVC.Controllers.BaseMobileController
    {
        // GET: MobileDataList/DataListMore
        ...
        public IActionResult btnMore_Click(int dataIndex)
        {
