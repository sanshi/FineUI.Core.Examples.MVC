...
{
    [Area("MobileDataList")]
    public class DataListLinkToPanelGroupArrowController : FineUI.Core.Examples.MVC.Controllers.BaseMobileController
    {
        // GET: MobileDataList/DataListLinkToPanelGroupArrow
