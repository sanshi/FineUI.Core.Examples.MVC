...
{
    [Area("MobileDataList")]
    public class DataListDataBindController : FineUI.Core.Examples.MVC.Controllers.BaseMobileController
    {
        // GET: MobileDataList/DataListDataBind
        ...
        public IActionResult btnReDataBind_Click(string source)
        {
