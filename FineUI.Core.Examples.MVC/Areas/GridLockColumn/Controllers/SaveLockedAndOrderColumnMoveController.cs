...
{
    [Area("GridLockColumn")]
    public class SaveLockedAndOrderColumnMoveController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        ...
        // GET: GridLockColumn/SaveLockedAndOrderColumnMove
