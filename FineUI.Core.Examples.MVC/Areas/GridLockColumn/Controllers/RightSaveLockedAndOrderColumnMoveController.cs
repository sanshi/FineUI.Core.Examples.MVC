...
{
    [Area("GridLockColumn")]
    public class RightSaveLockedAndOrderColumnMoveController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        ...
        // GET: GridLockColumn/RightSaveLockedAndOrderColumnMove
        ...
        public IActionResult Grid1_ColumnLockUnlock(JArray configedColumns)
        {
