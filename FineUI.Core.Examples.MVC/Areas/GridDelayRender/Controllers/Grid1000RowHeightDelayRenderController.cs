...
namespace FineUI.Core.Examples.MVC.Areas.GridRowGroup.Controllers
{
    ...
    public class Grid1000RowHeightDelayRenderController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: GridDelayRender/Grid1000RowHeightDelayRender
