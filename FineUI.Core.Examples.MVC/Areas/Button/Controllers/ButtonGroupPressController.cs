...
{
    [Area("Button")]
    public class ButtonGroupPressController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        ...
        public IActionResult ButtonGroup_PressChanged(JObject pressedInfo)
        {
            // 将传入的字符串转换为 JSON 对象
