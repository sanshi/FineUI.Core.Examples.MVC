...
{
    [Area("Form")]
    public class FileUploadController : FineUI.Core.Examples.MVC.Controllers.BaseUploadController
    {
        // GET: Form/FileUpload
        ...
        public IActionResult btnSubmit_Click(IFormFile filePhoto, IFormCollection values)
        {
            if (filePhoto != null)
            {
                ...
                else
                {
                    ...
                    PageContext.RegisterStartupScript("window.a=12;");
                    ...
                    PageContext.RegisterStartupScript("window.b=12;");
                }
            }
