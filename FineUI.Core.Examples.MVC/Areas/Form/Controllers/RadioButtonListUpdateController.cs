...
{
    [Area("Form")]
    public class RadioButtonListUpdateController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        ...
        public IActionResult btnCheckedItemsList_Click(string name, string selected)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult btnUpdateList1_Click()
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult btnUpdateList2_Click()
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult btnUpdateList4_Click(int count)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult btnUpdateList3_Click()
        {
