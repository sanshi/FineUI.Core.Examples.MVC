...
{
    [Area("Form")]
    public class CheckBoxListAutoColumnWidthController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: Form/CheckBoxListAutoColumnWidth
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult CheckBoxList3_SelectedIndexChanged(string[] selected)
        {
