...
{
    [Area("Form")]
    public class FileUploadMultipleController : FineUI.Core.Examples.MVC.Controllers.BaseUploadController
    {
        // GET: Form/FileUploadMultiple
        ...
        public IActionResult btnSubmit_Click(List<IFormFile> filePhotos, IFormCollection values)
        {
