...
{
    [Area("Form")]
    public class ChangeConfirmFormTableController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: Form/ChangeConfirmFormTable
        ...
        public IActionResult btnClosePostBack_Click(IFormCollection values, string[] Grid1_fields, JArray Grid1_modifiedData)
        {
