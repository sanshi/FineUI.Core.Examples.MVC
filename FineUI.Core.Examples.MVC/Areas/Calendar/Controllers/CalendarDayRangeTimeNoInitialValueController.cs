...
{
    [Area("Calendar")]
    public class CalendarDayRangeTimeNoInitialValueController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        ...
        // GET: Calendar/CalendarDayRangeTimeNoInitialValue
