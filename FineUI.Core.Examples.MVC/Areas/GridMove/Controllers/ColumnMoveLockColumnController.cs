...
{
    [Area("GridMove")]
    public class ColumnMoveLockColumnController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        ...
        public IActionResult Grid1_ColumnMoveOrLock(JArray columnIds, JArray lockedColumnIds)
        {
            // 模拟操作数据库中的数据
