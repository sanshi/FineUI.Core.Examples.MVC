...
{
    [Area("DatePicker")]
    public class DatePickerDayRangeTimeShowSecondController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: DatePicker/DatePickerDayRangeTimeShowSecond
