...
{
    [Area("DatePicker")]
    public class DatePickerYearRangeConfirmButtonController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: DatePicker/DatePickerYearRangeConfirmButton
