...
{
    [Area("DatePicker")]
    public class DatePickerDayRangeConfirmButtonController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: DatePicker/DatePickerDayRangeConfirmButton
