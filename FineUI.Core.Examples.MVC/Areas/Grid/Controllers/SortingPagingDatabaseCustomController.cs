...
{
    [Area("Grid")]
    public class SortingPagingDatabaseCustomController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        ...
        public IActionResult Grid1_PageIndexChangedOrSort(string[] fields, int pageIndex, string sortField, string sortDirection)
        {
