...
{
    [Area("Grid")]
    public class SortingPagingDatabaseMultiController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: Grid/SortingPagingDatabaseMulti
        ...
        public IActionResult Grid1_PageIndexChangedOrSort(string[] Grid1_fields, int Grid1_pageIndex, string[] Grid1_sortFields)
        {
