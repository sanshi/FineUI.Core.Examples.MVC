...
{
    [Area("Grid")]
    public class GroupFieldHiddenController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        ...
        public ActionResult Button3_Click(bool anhuiHidden)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Button1_Click(bool zhumadianHidden)
        {
            var grid1 = UIHelper.Grid("Grid1");
            if (zhumadianHidden)
            {
