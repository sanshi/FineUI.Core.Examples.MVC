...
{
    [Area("Grid")]
    public class DynamicColumnsPostBackController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: Grid/DynamicColumnsPostBack
        ...
        public IActionResult DropDownList1_SelectedIndexChanged(string selected)
        {
