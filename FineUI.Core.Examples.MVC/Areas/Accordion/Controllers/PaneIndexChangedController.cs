...
{
    [Area("Accordion")]
    public class PaneIndexChangedController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Accordion1_PaneIndexChanged(int activeIndex)
        {
