...
{
    [Area("GridTree")]
    public class LazyLoadController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        ...
        public IActionResult Grid1_RowLazyLoad(string rowId, string[] Grid1_fields)
        {
