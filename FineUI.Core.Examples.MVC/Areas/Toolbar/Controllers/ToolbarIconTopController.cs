...
{
    [Area("Toolbar")]
    public class ToolbarIconTopController : FineUI.Core.Examples.MVC.Controllers.BaseUploadController
    {
        ...
        public IActionResult filePhoto_FileSelected(IFormFile filePhoto)
        {
            if (filePhoto != null)
            {
