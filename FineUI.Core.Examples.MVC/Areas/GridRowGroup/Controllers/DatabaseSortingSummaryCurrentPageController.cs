...
{
    [Area("GridRowGroup")]
    public class DatabaseSortingSummaryCurrentPageController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: GridRowGroup/DatabaseSortingSummaryCurrentPage
        ...
        public IActionResult Grid1_PageIndexChangedOrSort(string[] Grid1_fields, int Grid1_pageIndex, string Grid1_sortField, string Grid1_sortDirection)
        {
