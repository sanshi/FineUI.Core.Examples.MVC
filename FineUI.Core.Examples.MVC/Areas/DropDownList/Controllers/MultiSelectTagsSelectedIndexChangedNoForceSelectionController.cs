...
{
    [Area("DropDownList")]
    public class MultiSelectTagsSelectedIndexChangedNoForceSelectionController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: DropDownList/MultiSelectTagsSelectedIndexChangedNoForceSelection
