...
{
    [Area("DropDownList")]
    public class ShengShiXian2Controller : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        ...
        public IActionResult ddlSheng_SelectedIndexChanged(string sheng)
        {
            BindShi(sheng);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult ddlShi_SelectedIndexChanged(string sheng, string shi)
        {
            BindXian(shi);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult btnSubmit_Click(string sheng, string shi, string xian)
        {
            // 香港、澳门 - 县区市为空
            string xianstr = " | " + xian;
            if(xian == "-1") {
