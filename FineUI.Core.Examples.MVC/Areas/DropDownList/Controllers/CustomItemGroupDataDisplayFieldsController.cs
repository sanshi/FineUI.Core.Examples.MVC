...
{
    [Area("DropDownList")]
    public class CustomItemGroupDataDisplayFieldsController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: DropDownList/CustomItemGroupDataDisplayFields
