...
{
    [Area("DropDownList")]
    public class MultiSelectTagsClearIconClickController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: DropDownList/MultiSelectClearIconClickTags
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult DropDownList1_ClearIconClick()
        {
