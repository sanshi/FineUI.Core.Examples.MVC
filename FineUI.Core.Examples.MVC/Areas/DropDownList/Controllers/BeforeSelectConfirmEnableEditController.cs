...
{
    [Area("DropDownList")]
    public class BeforeSelectConfirmEnableEditController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: DropDownList/BeforeSelectConfirmEnableEdit
