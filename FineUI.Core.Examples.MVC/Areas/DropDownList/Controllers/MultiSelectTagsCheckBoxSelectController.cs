...
{
    [Area("DropDownList")]
    public class MultiSelectTagsCheckBoxSelectController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: DropDownList/MultiSelectCheckBoxSelectTags
