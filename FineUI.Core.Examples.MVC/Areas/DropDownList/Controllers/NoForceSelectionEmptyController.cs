...
{
    [Area("DropDownList")]
    public class NoForceSelectionEmptyController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult btnRebindData_Click(int dataLength)
        {
