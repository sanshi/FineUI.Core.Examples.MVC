...
{
    [Area("DropDownList")]
    public class SimulateTreeController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult btnDataBind_Click(string DropDownList1, string DropDownList1_text)
        {
