...
{
    [Area("DropDownList")]
    public class MultiSelectTagsSelectedIndexChangedEnableEditController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: DropDownList/MultiSelectTagsSelectedIndexChangedEnableEdit
