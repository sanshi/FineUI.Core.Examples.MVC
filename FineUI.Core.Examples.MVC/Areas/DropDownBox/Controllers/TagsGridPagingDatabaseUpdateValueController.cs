...
{
    [Area("DropDownBox")]
    public class TagsGridPagingDatabaseUpdateValueController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: DropDownBox/TagsGridPagingDatabaseUpdateValue
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult btnClearValue_Click()
        {
