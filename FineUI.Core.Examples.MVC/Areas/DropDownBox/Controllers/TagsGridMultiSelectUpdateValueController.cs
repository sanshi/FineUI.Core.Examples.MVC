...
{
    [Area("DropDownBox")]
    public class TagsGridMultiSelectUpdateValueController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: DropDownBox/TagsGridMultiSelectUpdateValue
