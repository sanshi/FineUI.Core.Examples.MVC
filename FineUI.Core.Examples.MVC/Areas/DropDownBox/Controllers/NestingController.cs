...
{
    [Area("DropDownBox")]
    public class NestingController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        ...
        public IActionResult ddlGender_SelectedIndexChanged(string ddlGender, string[] ddbMajor, string[] Grid1_fields)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult ddbMajor_TextChanged(string ddlGender, string[] ddbMajor, string[] Grid1_fields)
        {
            BindGrid(ddlGender, ddbMajor, Grid1_fields);
            return UIHelper.Result();
        }
