...
{
    [Area("DropDownBox")]
    public class GridPagingDatabaseClearIconClickController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: DropDownBox/GridPagingDatabaseClearIconClick
        ...
        public IActionResult btnGetSelection_Click(string[] DropDownBox1, string DropDownBox1_text)
        {
         ...
         [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult DropDownBox1_ClearIconClick()
        {
