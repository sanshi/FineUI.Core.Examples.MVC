...
{
    [Area("DropDownBox")]
    public class GridSearchDropDownListController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        ...
        public IActionResult Grid1_DoReBind(string[] Grid1_fields, int Grid1_pageIndex, string ddlAtSchool, JArray Grid1_filteredData)
        {
