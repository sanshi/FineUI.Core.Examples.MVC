...
{
    [Area("DropDownBox")]
    public class CheckBoxListSelectAllController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: DropDownBox/CheckBoxListSelectAll
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult btnSelectItem6_Click(object sender, EventArgs e)
        {
