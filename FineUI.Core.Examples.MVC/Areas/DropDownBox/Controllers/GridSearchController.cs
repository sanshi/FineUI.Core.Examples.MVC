...
{
    [Area("DropDownBox")]
    public class GridSearchController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        ...
        public IActionResult ttbSearch_Trigger1Click(string[] Grid1_fields, int Grid1_pageIndex)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Grid1_DoReBind(string[] Grid1_fields, int Grid1_pageIndex, string ttbSearch)
        {
