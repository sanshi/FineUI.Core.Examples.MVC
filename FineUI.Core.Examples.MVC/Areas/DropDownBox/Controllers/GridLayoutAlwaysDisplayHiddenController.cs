...
{
    [Area("DropDownBox")]
    public class GridLayoutAlwaysDisplayHiddenController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: DropDownBox/GridLayoutAlwaysDisplayHidden
        ...
        public IActionResult ttbSearch_Trigger1Click(string[] Grid1_fields, int Grid1_pageIndex, string rblAtSchool)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Grid1_DoReBind(string[] Grid1_fields, int Grid1_pageIndex, string ttbSearch, string rblAtSchool)
        {
