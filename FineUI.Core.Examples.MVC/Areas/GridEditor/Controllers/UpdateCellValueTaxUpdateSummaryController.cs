...
{
    [Area("GridEditor")]
    public class UpdateCellValueTaxUpdateSummaryController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: GridEditor/UpdateCellValueTaxUpdateSummary
        ...
        public IActionResult btnSubmit_Click(string[] fields, JArray mergedData)
        {
			int rowIndex = 0;
            // 复制原始表格的结构
