...
{
    [Area("GridEditor")]
    public class AfterEditSelectCellController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        ...
        public IActionResult Grid1_AfterEdit(string[] Grid1_fields, JArray Grid1_modifiedData, string[] selectedCell)
        {
