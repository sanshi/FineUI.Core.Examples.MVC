...
{
    [Area("GridEditor")]
    public class AfterEditRowExpanderController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: GridEditor/AfterEditRowExpander
        ...
        public IActionResult Grid1_AfterEdit(string[] Grid1_fields, JArray Grid1_modifiedData)
        {
