...
{
    [Area("GridEditor")]
    public class UpdateCellValueHiddenColumnController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: GridEditor/UpdateCellValueHiddenColumn
        ...
        public IActionResult btnSubmit_Click(string[] Grid1_fields, JArray Grid1_modifiedData)
        {
