...
{
    [Area("Tree")]
    public class TreeIconFontColorXmlController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        ...
        {
            string xmlPath = PageContext.MapPath("~/Areas/Tree/Content/tree_iconfont_randomcolor.xml");
