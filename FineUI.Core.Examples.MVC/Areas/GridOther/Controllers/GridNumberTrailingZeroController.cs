...
{
    [Area("GridOther")]
    public class GridNumberTrailingZeroController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: GridOther/GridNumberTrailingZero
        public IActionResult Index()
        {
            ViewBag.ExtendedTableSource = GetExtendedDataTable();
