...
{
    [Area("GridOther")]
    public class DateOnlyController : FineUI.Core.Examples.MVC.Controllers.BaseController
    {
        // GET: GridOther/DateOnly
        ...
        public IActionResult Button2_Click(JArray selected)
        {
