...
{
    [Area("MobileWindow")]
    public class PositionShengShiXianController : FineUI.Core.Examples.MVC.Controllers.BaseMobileController
    {
        // GET: MobileWindow/PositionShengShiXian
        ...
        public IActionResult ddlSheng_SelectedIndexChanged(IFormCollection values)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult ddlShi_SelectedIndexChanged(IFormCollection values)
        {
